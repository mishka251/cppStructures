...
void menu() {
	while (true) {
		cout
			<< "Введите команду: 0 - выход, 1 - ввод с клавиатуры, 2 - ввод из файла, 3 - вывод на экран, 4 - поиск самого высокого дерева, 5 - вывод деревьев с дуплом, 6 - сортирвока массивов, 7 - вывод информации про лес"
			<< endl;
		int command;
		cin >> command;
